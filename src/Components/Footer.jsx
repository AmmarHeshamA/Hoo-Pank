...
const Footer = () => (
  ...
  >
    <div
      className={`${styles.flexStart} md:flex-row first-letter:flex-col
    mb-8 w-full`}
    >
      ...
      >
        {footerLinks.map((footerlink) => (
          <div
            key={footerlink.title} // Changed key to use title instead
          ...
          >
            ...
            <ul className="list-none mt-4">
              {footerlink.links.map((link, index) => (
                <li
                  key={`${footerlink.title}-${link.name}`} // Changed key to a combination of title and link name
    ...
    >
      <p
        ...
        text-center leading-[27px] text-white"
      >
